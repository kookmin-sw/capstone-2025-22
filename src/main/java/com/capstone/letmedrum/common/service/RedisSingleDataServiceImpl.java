...
public class RedisSingleDataServiceImpl implements RedisSingleDataService {
    ...
    * */
    public RedisSingleDataServiceImpl(RedisTemplate<String, Object> redisTemplate, RedisOperationExecutor redisOperationExecutor) {
    ...
    * */
    @Override
    public boolean setValue(String key, String value, int expSeconds) {
