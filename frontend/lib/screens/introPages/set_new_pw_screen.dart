...
class _SetNewPwScreenState extends State<SetNewPwScreen> {
  ...
  final _passwordController = TextEditingController(); // 새 비밀번호 입력 컨트롤러
  final _confirmPasswordController = TextEditingController(); // 새 비밀번호 확인 컨트롤러
  ...
  String? _validatePassword(String? value) {
    if (value == null || value.isEmpty) {
      return '8~20자의 영문, 숫자, 특수문자를 모두두 포함해주세요.';
    }
    if (!RegExp(
          ...
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    height: 50,
                    child: introPageHeader(title: '비밀번호 재설정'),
                  ),
                  Text(
